...
<div id="content">
	...
	<div id="section">
		<div id="rug5">
		<div id="label">Member List</div>
		<center>
		<table id="table" cellpadding="10" cellspacing="10">
		<tr><th>Name</th><th>Opsi</th></tr>
		...
		<?php
			...
			echo"
		<tr><td >$name</td>
			<td align='Center'><a href='updatemember.php?id=$row[username]'><img src='pic/edit.png' width='15px' height='15px' title='update'></a> |
			<a href='deletemember.php?id=$row[username]'><img src='pic/delete.png' width='15px' height='15px' title='delete'></a></td></tr>";
			}
		echo '</table>';
				?>
		</center>
