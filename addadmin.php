...
<?php 
		...
		<table cellpadding="10" cellspacing="10" >
			...
			<tr><td ><textarea id="texta" name="pertanyaan" placeholder="Pertanyaan Keamanan"></textarea></td></tr>
			<tr><td ><textarea id="texta" name="jawaban" placeholder="Jawaban"></textarea></td></tr>
			<tr><td align="right"><input id="button1" type="submit" value="Add"></td></tr>
		</table>
		</form> ';
error_reporting(0);
		$konfirmasi = $_GET[m];
		...
		elseif($konfirmasi=="ukosong"){
			echo'<script>alert("Isikan username");</script>';}
		elseif($konfirmasi=="pkosong"){
			echo'<script>alert("Isikan Password");</script>';}
		elseif($konfirmasi=="fkosong"){
			echo'<script>alert("Isikan Fullname");</script>';}
		elseif($konfirmasi=="perkosong"){
			echo'<script>alert("Isikan Pertanyaan Keamanan");</script>';}
		elseif($konfirmasi=="jkosong"){
			echo'<script>alert("Isikan Jawaban");</script>';}
?>
		</center>
		</div>
	</div>
