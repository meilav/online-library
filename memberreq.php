...
<div id="content">
	...
	<div id="section">
		<div id="rug5">
		<div id="label"> Member Request </div>
		<center>
			<?php
			include "connect.php";

				$query = "SELECT * FROM member where password=''";
				$exe = mysql_query($query);
				$yeah = mysql_num_rows($exe);
				$no = 1;
			if ($yeah==0){
					echo"<br><Br><br><font face='verdana' >Tidak ada Member Request </font>";
				} 
			else {
			echo '<table cellpadding="10" cellspacing="15" id="table">
			<tr><th align="left">No</th><th >Name</th><th> NIM</th><th>Option</th></tr>';
			...
			while($row= mysql_fetch_array($exe)){
					...
					echo "<tr><td>$no</td>
							<td>$naruto</td>
							<td align='center'>$koga</td>
							<td><center><a href='confirm.php?id=$row[username]' >Confirm</a> | 
										<a href='decline.php?id=$row[username]'>Decline</a></center></td>
						</tr>";
						$no++;
						}
				} ?>
