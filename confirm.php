...
include"connect.php";
	$id=$_GET['id'];
	$query = mysql_query("SELECT * FROM member WHERE username='$id'")or die (mysql_error());
...
<div id="content" style="height: 700px;">
	...
	<div id="section">
		<div id="rug5">
		<div id="label"><?php echo "$fullname"; ?> </div>
		<center>
		<form action="confirmation.php" method="POST">
		<table id="table" cellspacing="10" cellpadding="10">
			<tr><td>Username</td><td>: <b><?php echo "$username"; ?></b></td></tr>
			<tr><td>Password</td><td>: <input type="text" name="pass" id="input">
										<input type="hidden" name="uname" id="input" value="<?php echo $username ?>"></td></tr>
			<tr><td>&nbsp;</td><td>&nbsp;&nbsp;<input type="submit" value="Update" id="button1"></td></tr>
		</table>
		</form>
		</center>
		</div>
