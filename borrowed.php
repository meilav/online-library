...
<ul>
   ...
   <li class='has-sub'><a href='#'><span>Book</span></a>
		<ul>
			<li><a href='Bookshelf.php'><span>Bookshelves</span></a></li>
			<li><a href='booklist.php'><span>Book List</span></a></li>
			<li class='last'><a href='e-book.php'>E-Book</span></a></li>
		</ul>
   </li>
...
<div id="content">
	...
	<div id="label"> Borrowed Books </div>
<?php
include"connect.php";

$query=mysql_query("SELECT * FROM borrowed ORDER BY tanggal_pinjam ASC");
$data = mysql_num_rows($query);
$no=1;

if ($data==0){
	echo"<br><br><Br>Tidak Ada Buku yang sedang Dipinjam";
}
else {
	echo'
		<table id="table" cellspacing="5" cellpadding="5">
		<tr>
			<th valign="top">No.</th><th valign="top">Nama</th><th valign="top">Judul Buku</th><th>Tanggal Pinjam</th><th>Tanggal Kembali</th><th valign="top">Konfirmasi</th>
		</tr>
...
while($row=mysql_fetch_array($query)){
	...
	echo"
		<tr>
			...
			<td>$tk</td>";
	if ($tk==""){ echo"
			<td align='center'><a href='konfirmasi.php?urut=$no'>konfirmasi</a></td>
		</tr>
	";}
	else { echo"
