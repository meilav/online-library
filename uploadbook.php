...
<?php
   ...
   <li class='has-sub'><a href='#'><span><img src='pic/user.png' width='15' height='13' > Admin $_SESSION[admin]</span></a>
	  ...
	  <li><a href='account.php'><span>My Account</span></a></li>
         ...
         <li><a href='uploadbook.php'><span>Upload E-Book</span></a></li>
...
<div id="content">
	...
	<div id="section">
		<div id="rug5">
		<div id="label"> Upload a Book </div>
		<center>
<?php
include"connect.php";
...
echo '
		...
		<tr><td>Jumlah Buku</td><td>: <input type="number" name="jumlah" id="input"></td></tr>
		<tr><td>Kode</td><td>: <input type="text" name="kode" id="input"></td></tr>
		<tr><td>Penulis</td><td>: <input type="text" name="penulis" id="input"></td></tr>
		<tr><td>Penerbit</td><td>: <input type="text" name="penerbit" id="input"></td></tr>
		<tr><td>Tahun Terbit</td><td>: <input type="text" name="tahun" id="input"></td></tr>
		<tr><td>Kota Terbit</td><td>: <input type="text" name="kota" id="input"></td></tr>
		<tr><td>Cover</td><td>: <input type="file" name="cover" required></td></tr>
		<tr><td>Jumlah Halaman</td><td>: <input type="text" name="jumhal" id="input" placeholder="contoh: xiv + 100 hlm."></td></tr>
		...
		<tr><td valign="top">Deskripsi</td><td valign="top">: <textarea name="deskripsi" id="texta"></textarea></td></tr>
...
error_reporting(0);
	...
	elseif($confirm=="jumnull")
		{ echo'<script>alert("Isikan Jumlah Buku"); </script>';}
	elseif($confirm=="knull")
		{ echo'<script>alert("Isikan Kode Buku"); </script>';}
	elseif($confirm=="pnull")
		{ echo'<script>alert("Isikan Penulis Buku"); </script>';}
	elseif($confirm=="pennull")
		{ echo'<script>alert("Isikan Penerbit Buku"); </script>';}
	elseif($confirm=="tnull")
		{ echo'<script>alert("Isikan Tahun Terbit Buku"); </script>';}
	elseif($confirm=="konull")
		{ echo'<script>alert("Isikan Kota Terbit Buku"); </script>';}
	elseif($confirm=="jhnull")
		{ echo'<script>alert("Isikan Jumlah Halaman Buku"); </script>';}
	elseif($confirm=="kanull")
		{ echo'<script>alert("Isikan Kategori Buku"); </script>';}
	elseif($confirm=="denull")
		{ echo'<script>alert("Isikan Deskripsi Buku"); </script>';}
