...
<div id="content">
	...
	<div id="section">
		...
		<?php
			...
			echo"
		<tr><td >$name</td>
			<td align='Center'><a href='update.php?id=$row[username]'><img src='pic/edit.png' width='20px' height='20px' title='update'></a>
				<a href='delete.php?id=$row[username]'><img src='pic/delete.png' width='20px' height='20px' title='delete'></a></td></tr>";
			}
		echo '</table>';
				?>
		</center>
